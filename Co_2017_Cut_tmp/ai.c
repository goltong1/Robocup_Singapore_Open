...
((CSLeft_R>140&&CSLeft_R<180&&CSLeft_G<80&&CSLeft_B<20)||
(CSRight_R>140&&CSRight_R<180&&CSRight_G<80&&CSRight_B<20)))
    {
        Duration = 3;
        CurAction =4;
    }
...
(CSRight_R>190&&CSRight_G>170&&CSRight_B<40))
    ...
    else if(LoadedObjects<6&&((CSLeft_R<70&&CSLeft_G<70&&CSLeft_B<70)
||(CSRight_R<70&&CSRight_G<70&CSRight_B<70)))
    {
        Duration = 44;
        CurAction =6;
    }
...
((CSLeft_R>190&&CSLeft_G<30&&CSLeft_B<20)||
(CSRight_R>190&&CSRight_G<30&&CSRight_B<20)))
    {
        Duration = 46;
        CurAction =8;
    }
    else if(CSLeft_R>=190 && CSLeft_R<=255 && CSLeft_G>=30 && CSLeft_G<=60 && CSLeft_B>=0 && CSLeft_B<=20 && CSRight_R>=190 && CSRight_R<=255 && CSRight_G>=30 && CSRight_G<=60 && CSRight_B>=0 && CSRight_B<=20&&(LoadedObjects>0))
    {
        Duration = 49;
        CurAction =9;
    }
    else if(CSLeft_R>=180 && CSLeft_R<=255 && CSLeft_G>=20 && CSLeft_G<=70 && CSLeft_B>=0 && CSLeft_B<=30&&(LoadedObjects>0))
    {
        Duration = 0;
        CurAction =10;
    }
    else if(CSRight_R>=180 && CSRight_R<=255 && CSRight_G>=20 && CSRight_G<=70 && CSRight_B>=0 && CSRight_B<=30&&(LoadedObjects>0))
    {
        Duration = 0;
        CurAction =11;
    }
    else if((CSLeft_R>200&&CSLeft_G>200&&(CSLeft_B<80&&CSLeft_B>30))||
(CSRight_R>200&&CSRight_G>200&&(CSRight_B<80&&CSRight_B>30))
)
    {
        Duration = 0;
        CurAction =12;
...
||(CSLeft_R>180&&CSRight_G<15&&CSRight_B>230))
    ...
    else if(CSLeft_R>=140 && CSLeft_R<=176 && CSLeft_G>=140 && CSLeft_G<=185 && CSLeft_B>=190 && CSLeft_B<=255 && PositionX>=230 && PositionX<=1000 && PositionY>=155 && PositionY<=1000&&(PositionX<283||PositionY<170))
    {
        Duration = 0;
        CurAction =3;
    }
    else if(CSRight_R>=140 && CSRight_R<=176 && CSRight_G>=140 && CSRight_G<=185 && CSRight_B>=190 && CSRight_B<=255 && PositionX>=230 && PositionX<=250 && PositionY>=155 && PositionY<=184&&(PositionX<283||PositionY<170))
    {
        Duration = 0;
        CurAction =4;
    }
    else if(Time>=2 && Time<=1&&(bSwamp==1))
    {
        Duration = 0;
        CurAction =5;
    }
    else if(LoadedObjects>0&&
((CSLeft_R>140&&CSLeft_R<190&&CSLeft_G<80&&CSLeft_B<20)||
(CSRight_R>140&&CSRight_R<190&&CSRight_G<80&&CSRight_B<20)))
    {
        Duration = 0;
        CurAction =6;
    }
...
(CSRight_R>190&&CSRight_G>170&&CSRight_B<40))
    ...
    else if(LoadedObjects<6&&((CSLeft_R<70&&CSLeft_G<50&CSLeft_B<50)
||(CSRight_R<70&&CSRight_G<50&CSRight_B<50)))
    {
        Duration = 44;
        CurAction =8;
    }
...
((CSLeft_R>190&&CSLeft_G<50&&CSLeft_B<30)||
(CSRight_R>190&&CSRight_G<50&&CSRight_B<30)))
    {
        Duration = 44;
        CurAction =10;
    }
    else if(CSLeft_R>=180 && CSLeft_R<=255 && CSLeft_G>=90 && CSLeft_G<=135 && CSLeft_B>=35 && CSLeft_B<=75 && CSRight_R>=180 && CSRight_R<=255 && CSRight_G>=90 && CSRight_G<=135 && CSRight_B>=35 && CSRight_B<=75&&(LoadedObjects>0))
    {
        Duration = 49;
        CurAction =11;
    }
    else if(CSLeft_R>=170 && CSLeft_R<=255 && CSLeft_G>=80 && CSLeft_G<=145 && CSLeft_B>=30 && CSLeft_B<=80&&(LoadedObjects>0))
    {
        Duration = 0;
        CurAction =12;
    }
    else if(CSRight_R>=170 && CSRight_R<=255 && CSRight_G>=80 && CSRight_G<=145 && CSRight_B>=30 && CSRight_B<=80&&(LoadedObjects>0))
    {
        Duration = 0;
        CurAction =13;
    }
    else if(PositionX>=150 && PositionX<=200 && PositionY>=190 && PositionY<=270 && Time>=1 && Time<=0)
    {
        Duration = 0;
        CurAction =14;
    }
    else if(PositionX>=1 && PositionX<=1000 && PositionY>=200 && PositionY<=270 && Time>=1 && Time<=0&&(WTC==0&&(PositionX<18||PositionX>347||PositionY>252||PositionY<50)
))
    {
        Duration = 0;
        CurAction =15;
    }
    else if(PositionX>=1 && PositionX<=1000 && PositionY>=1 && PositionY<=1000&&(WTC==0&&(PositionX<16||PositionX>344||PositionY<16||PositionY>235)
))
    {
        Duration = 0;
        CurAction =16;
    ...
    else if(true)
    {
        Duration = 0;
        CurAction =20;
        if(PositionX>=148 && PositionX<=207 && PositionY>=136 && PositionY<=250&&((LoadedObjects>3&&WTC==0)||(Time>460&&WTC==0&&LoadedObjects>0)))
        {
            Duration = 0;
            CurAction =21;
        }
        else if(PositionX>=245 && PositionX<=341 && PositionY>=197 && PositionY<=244&&((LoadedObjects>3&&WTC==0)||(Time>460&&WTC==0&&LoadedObjects>0)))
        {
            Duration = 0;
            CurAction =22;
        }
