...
||(CSLeft_R>180&&CSRight_G<15&&CSRight_B>230))
    ...
    else if(abs(PositionX-SuperObj_X)<6&&abs(PositionY-SuperObj_Y)<6)
    {
        Duration = 44;
        CurAction =3;
    }
...
(CSRight_R>175&&CSRight_G<50&&CSRight_B<50)))
    ...
    else if(PositionX>=1 && PositionX<=1000 && PositionY>=1 && PositionY<=1000&&(WTC==0&&(PositionX<16||PositionX>344||PositionY<16||PositionY>260)
))
    {
        Duration = 0;
        CurAction =15;
    ...
    else if(true)
    {
        Duration = 0;
        CurAction =19;
        if(PositionX>=18 && PositionX<=350 && PositionY>=234 && PositionY<=269&&((LoadedObjects>3&&WTC==0)||(Time>460&&WTC==0&&LoadedObjects>0)))
        {
            Duration = 0;
            CurAction =20;
        }
        else if(PositionX>=1 && PositionX<=349 && PositionY>=1 && PositionY<=35&&((LoadedObjects>3&&WTC==0)||(Time>460&&WTC==0&&LoadedObjects>0)))
        {
            Duration = 0;
            CurAction =21;
        }
...
{WheelLeft=-2;
 ...
 //Set Avoid Degrees
 if(PositionY>133)
 {if(PositionY<200){TargetTheta=220;
                    }else{TargetTheta=340;
                    }}
 else
 {if(PositionY<47){TargetTheta=150;
                    }else{TargetTheta=40;
                    }}
 ...
 if(TargetTheta==340){if(Compass>180){wHead=-1;
                    }}
 if(TargetTheta==220){if(Compass<220){wHead=-1;
                    }}
 if(TargetTheta==40){if(Compass>200||Compass<40){wHead=-1;
                    }}
