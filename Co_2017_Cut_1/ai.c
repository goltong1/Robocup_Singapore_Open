...
(CSRight_R>175&&CSRight_G<50&&CSRight_B<50)))
    ...
    else if(true)
    {
        ...
        else if(PositionX>=290 && PositionX<=350 && PositionY>=97 && PositionY<=135&&((LoadedObjects>3&&WTC==0)||(Time>460&&WTC==0&&LoadedObjects>0)))
        {
            Duration = 0;
            CurAction =22;
        }
...
{WheelLeft=-2;
 ...
 //Set Avoid Degrees
 if(PositionX>211)
 {if(PositionY>116){TargetTheta=0;
                    }else{TargetTheta=90;
                    }}
 else
 {if(PositionY>55){TargetTheta=0;
